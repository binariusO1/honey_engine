...
bool isPointInside(const geometry::Point2Df& point, const std::vector<geometry::Point2Df>& points)
{
...
float getPointXCenterOfPolygon(const float area, const std::list<geometry::Point2Df>& points)
{
    float pointX = 0.0;
    float xi = 0.0;
    float yi = 0.0;
...
float getPointYCenterOfPolygon(const float area, const std::list<geometry::Point2Df>& points)
{
    float pointY = 0.0;
    float xi = 0.0;
    float yi = 0.0;
...
geometry::Point2Df getCenterOfPolygon(const float area, const std::list<geometry::Point2Df>& points)
{
    return geometry::Point2Df{getPointXCenterOfPolygon(area, points), getPointYCenterOfPolygon(area, points)};
}

float getPolygonsSignedArea(const std::list<geometry::Point2Df>& points)
{
    float area = 0.0;
    float fxi = 0.0;
    float fyi = 0.0;
